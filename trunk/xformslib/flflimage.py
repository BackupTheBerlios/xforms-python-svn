...
def flimage_convert(pImage, newtype, ncolors):
    ...
    libr.check_if_initialized()
    libr.verify_flflimageptr_type(pImage)
    libr.checkfatal_allowed_value_in_list(newtype, xfdata.FLIMAGETYPE_list)
...
def flimage_type_name(imagetype):
    ...
    libr.check_if_initialized()
    libr.checkfatal_allowed_value_in_list(imagetype, xfdata.FLIMAGETYPE_list)
...
def flimage_add_marker(pImage, name, x, y, w, h, style, fill, rot, \
    ...
    libr.check_if_initialized()
    libr.verify_flflimageptr_type(pImage)
    libr.checkfatal_allowed_value_in_list(style, xfdata.LINESTYLE_list)
...
def flimage_rotate(pImage, angle, subpixel):
    ...
    libr.check_if_initialized()
    libr.verify_flflimageptr_type(pImage)
    libr.checkfatal_allowed_value_in_list(subpixel, xfdata.FLIMAGESUBPIXROT_list)
