...
def fl_add_input(inputtype, x, y, w, h, label):
    ...
    libr.checkfatal_allowed_value_in_list(inputtype, xfdata.INPUTTYPE_list)
...
def fl_set_input_color(pFlObject, txtcolr, curscolr):
    ...
    libr.check_if_initialized()
    libr.verify_flobjectptr_type(pFlObject)
    libr.checkfatal_allowed_value_in_list(txtcolr, xfdata.COLOR_list)
    libr.checkfatal_allowed_value_in_list(curscolr, xfdata.COLOR_list)
...
def fl_set_input_format(pFlObject, fmt, sep):
    ...
    libr.check_if_initialized()
    libr.verify_flobjectptr_type(pFlObject)
    libr.checkfatal_allowed_value_in_list(fmt, xfdata.DATEFMT_list)
...
def fl_set_input_hscrollbar(pFlObject, pref):
    ...
    libr.check_if_initialized()
    libr.verify_flobjectptr_type(pFlObject)
    libr.checkfatal_allowed_value_in_list(pref, xfdata.SCROLLBARVAL_list)
