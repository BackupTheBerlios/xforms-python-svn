...
class Fd_chart(object):
    ...
    def create_forms(self):
        ...
        self.pchart = xfl.fl_add_chart(xfl.FL_PIE_CHART, 50, 30, 230, 110, 'mialabel')
        xfl.fl_set_object_boxtype(self.pchart, xfl.FL_BORDER_BOX)
        xfl.fl_set_object_color(self.pchart, xfl.FL_COL1, xfl.FL_COL1)
        xfl.fl_set_object_lalign(self.pchart, xfl.FL_ALIGN_BOTTOM)
        xfl.fl_set_object_lstyle(self.pchart, xfl.FL_NORMAL_STYLE)
        xfl.fl_set_object_lsize(self.pchart, xfl.FL_DEFAULT_SIZE)
        xfl.fl_set_object_lcol(self.pchart, xfl.FL_BLACK)
        xfl.fl_set_object_resize(self.pchart, xfl.FL_RESIZE_ALL)
        xfl.fl_set_object_gravity(self.pchart, xfl.FL_NoGravity, xfl.FL_NoGravity)
        xfl.fl_set_object_shortcut(self.pchart, 'l', 1)
        xfl.fl_set_object_callback(self.pchart, self.chartcb, 2)

        xfl.fl_end_form()

    def chartcb(self, pobj, data):
        pass
