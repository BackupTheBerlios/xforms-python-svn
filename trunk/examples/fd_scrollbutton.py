...
class My_scrollbutton(object):
    def __init__(self, lsysargv, sysargv):
        xfl.fl_initialize(lsysargv, sysargv, 'My_scrollbutton', None, 0)
    ...
    def create_forms(self):
        ...
        self.pscrollbtn = xfl.fl_add_lightbutton(xfl.FL_TOUCH_BUTTON, 50, 40, 130, 80, '8')
...
if __name__ == '__main__':
    ApplDemo = My_scrollbutton(len(sys.argv), sys.argv)