...
class Flinvslider(object):
    def __init__(self, lsysargv, sysargv):
        ...
        xfl.fl_show_form(self.ui.inv, xfl.FL_PLACE_CENTER | \
                xfl.FL_FREE_SIZE, xfl.FL_TRANSIENT, "inv")
        while not xfl.fl_is_same_object(xfl.fl_do_forms(), self.ui.done):
            pass            # empty
        xfl.fl_finish()
        sys.exit(0)
    ...
    def create_form_inv(self):
        ...
        fdui.sl[1] = xfl.fl_add_valslider(xfl.FL_VERT_FILL_SLIDER, 65, 30, \
                35, 230, "")
        fdui.sl[2] = xfl.fl_add_valslider(xfl.FL_VERT_NICE_SLIDER, 115, \
                30, 35, 230, "")
