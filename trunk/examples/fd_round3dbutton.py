...
class My_round3dbutton(object):
    def __init__(self, lsysargv, sysargv):
        xfl.fl_initialize(lsysargv, sysargv, 'My_round3dbutton', None, 0)
    ...
    def round3dcb(self, pobj, data):
        pass


if __name__ == '__main__':
    ApplDemo = My_round3dbutton(len(sys.argv), sys.argv)